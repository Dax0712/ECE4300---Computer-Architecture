...
module decode(
    ...
    regfile rf0(
        ...
        .rs(if_id_instr[25:21]), // coming from instruction bits [25:21]
        .rt(if_id_instr[20:16]), // coming from instruction bits [20:16]
        .rd(wb_write_reg_location), // coming from write-back stage
    ...
    control c0(
        ...
        .clk(clk),
        .rst(rst),
        .opcode(if_id_instr[31:26]), // coming from instruction bits [31:26]
        .wb(wb_internal),
        .mem(mem_internal),
        .ex(ex_internal)
    ); 
